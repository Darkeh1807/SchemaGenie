    ...
    <div className="absolute w-full flex justify-center items-center bottom-10 left-0 z-50 ">
      <div className="relative flex items-center justify-center w-5/6 lg:w-1/2">
        <textarea
          ...
          placeholder="Ask anything... eg. Schema for todo application"
          className="w-full bg-white pl-4 pt-3 rounded-2xl placeholder:text-[#7D8187] border border-black/10 shadow-black/10 focus:outline-none focus:ring-2 focus:ring-blue-500 "
          rows={4}
        />
